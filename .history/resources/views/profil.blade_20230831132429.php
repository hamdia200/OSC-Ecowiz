...
<html lang="fr">
    ...
    <div class="row">
        <div class="col-md-6 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img src="{{asset('/image/connexion.png')}}" width="150px"><span class="font-weight-bold">Ecowiz</span><span class="text-black-50">ecowiz@gmail.com</span><span> </span></div>
        </div>
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6"><label class="labels">Identifiant</label><input type="text" class="form-control" placeholder="Veuillez entrez votre identifiant" value=""></div>
                    <div class="col-md-6"><label class="labels"> Email </label><input type="text" class="form-control" placeholder="Veuillez saisir votre email" value=""></div>
