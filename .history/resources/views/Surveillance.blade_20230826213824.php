            ...
            <body>
                <div class="container">
                    <div class="content">
                        ...
                        <div class="tableau d-flex justify-content-center" style="margin-top: 110px;">
                        ...
                        <table class="table table-striped">
                            ...
                            <div class="graph">
                                <div class="chart">
                                    ...
                                    <div class="chif">
                                        <h1 style="font-size: 18px; color: var(--primary, #1758EC);">24kw</h1>
                                        <h1 style="font-size: 18px; color: var(--primary, #1758EC);">5000FCFA</h1>
                                    </div>
                                </div>
