                ...
                <div class="container">
                    <div class="content">
                        ...
                        <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                            <input placeholder="Poste de conso" type="text" id="example" class="form-control" class="fas fa-calendar input-prefix">
                            <i class="fas fa-calendar input-prefix" style="width: 50px; height: 50px; padding-left:10px; padding-right:10px;color:#C52B2B"></i>
                        </div>
