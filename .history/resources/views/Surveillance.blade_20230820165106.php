...
@section('content')
    <div class="container">
        ...
        <body>
                ...
                <select id="jour">
                    <option value="2023">O1</option>
                    <option value="2024">O2</option>
                    <option value="2025">O3</option>
                    <option value="2026">O4</option>
                    <option value="2027">O5</option>
                    <option value="2028">O6</option>
                    <option value="2029">O7</option>
