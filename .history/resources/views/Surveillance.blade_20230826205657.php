                        ...
                        <table class="table table-striped">
                            ...
                            <div class="graph">
                                <div class="chart">
                                    ...
                                    <div class="chif">
                                        <h1 style="font-size: 18px; color:#000000">24kw</h1>
                                        <h1 style="font-size: 18px; color:#000000">5000FCFA</h1>
                                    </div>
                                </div>

                                <div class="alert">
                                        <h1>Notification <i class="fas fa-bell" style="width: 50px; height: 50px; padding-left:100px; padding-right:100px;color:#C52B2B"></i></h1>
