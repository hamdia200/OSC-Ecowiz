        ...
        <header class="head">
                <ul class="menu-horizontal fixed-top wrap">
                    ...
                    <li class="@if(Request::is('notification')) active @endif">
                        <span class="menu-item">
                            <i class="fas fa-bell"></i> <a href="{{route('notification')}}"><span class="menu-text">Notification</span></a>
                        </span>
                    </li>
                    <li class="@if(Request::is('assistance')) active @endif">
                        <span class="menu-item">
                            <i class="fas fa-question-circle"></i> <a href="{{route('assistance')}}"><span class="menu-text">Assistance</span></a>
                        </span>
                    </li>
                </ul>
