...
<head>
    ...
    <script>
        // Ajoutez la classe de transition après un délai
        setTimeout(function () {
            document.body.classList.add('fade-out');
        }, 2000); // 2 secondes

        // Redirigez vers la nouvelle page après la fin de la transition
        setTimeout(function () {
            window.location.href = '{{chemin/vers/votre/nouvelle/page.html}}';
        }, 4000); // 4 secondes (2 secondes de transition + 2 secondes avant la transition)
    </script>
</head>
<body>
        <div class="header">
