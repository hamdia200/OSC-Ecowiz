    ...
    <body>
                ...
                <ul class="menu-horizontal fixed-top wrap">
                    ...
                    <li>
                        <span class="menu-item @if(Request::is('prediction')) active @endif">
                            <i class="fas fa-history @if(Request::is('prediction')) active-icon @endif"></i> <a href="{{route('prediction')}}"><span class="menu-text">Prédiction</span></a>
                        </span>
                    </li>
                    <li>
        ...
        <div class="menu-container">
            ...
            <div id="mySidebar" class="sidebar">
                ...
                <a href="{{route('accueil')}}"><i class="fas fa-home"></i> <span class="menu-text">Accueil</span></a>
                <a href="{{route('regulation')}}"><i class="fas fa-bolt"></i> <span class="menu-text">Régulation de l'électricité</span></a>
                <a href="{{route('profil')}}"><i class="fas fa-user"></i> <span class="menu-text">Profil</span></a>
                <a href="{{route('Surveillance')}}"><i class="fas fa-eye"></i> <span class="menu-text">Surveillance de données</span></a>
                <a href="{{route('prediction')}}"><i class="fas fa-chart-line"></i> <span class="menu-text">Prédiction</span></a>
                <a href="{{route('notification')}}"><i class="fas fa-bell"></i> <span class="menu-text">Notification</span></a>
                <a href="{{route('historique')}}"><i class="fas fa-history"></i> <span class="menu-text">Historique</span></a>
            </div>
        </div>
