        ...
        <header class="head">
                <ul class="menu-horizontal fixed-top wrap">
                    <div class="header">
                        ...
                        <img src="{{asset('/image/eco.png')}}" alt="" class="logo">
                    </div>
                    <li>
                    ...
                    <li>
                        <span class="menu-item @if(Request::is('notification')) active @endif">
                            <i class=" fas fa-history @if(Request::is('notification')) active-icon @endif"></i> <a href="{{route('historique')}}"><span class="menu-text">Historique</span></a>
                        </span>
                    </li>
                </ul>
