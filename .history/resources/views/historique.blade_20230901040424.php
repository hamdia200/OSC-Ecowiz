...
timeRangeButtons.forEach(function (button) {
    button.addEventListener("click", function () {
        ...
        var newData = generateDataForTimeRange(range); // Vous devez implémenter cette fonction
...
function generateDataForTimeRange(hours) {
    // Générer des données pour la plage de temps donnée (24h, 7j, 30j, 3mois, 12mois)
    // Retourner un tableau de valeurs
