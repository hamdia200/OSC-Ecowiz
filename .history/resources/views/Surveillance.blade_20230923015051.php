            ...
            <body>
                        ...
                        <table class="table table-striped">
                            ...
                            <div class="graph">
                                <div class="chart">
                                    ...
                                    <div class="chif">
                                        <h1 style="font-size: 19px; color: var(--primary, #1758EC);">24kw</h1>
                                        <h1 style="font-size: 19px; color: var(--primary, #1758EC);">5000FCFA</h1>
                                    </div>
                                </div>
                ...
                <script>
                    ...
                    var myChart = new Chart(ctx, {
                        type: 'doughnut',
                        data: {
                            labels: ['Chauffe-eau ', 'Climatisation', 'Téléviseur','Réfrigerateur','ventilateur','ampoule','Thermotre'], // Étiquettes de chaque section
                            datasets: [{
