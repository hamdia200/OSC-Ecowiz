                ...
                <ul class="menu-horizontal fixed-top wrap">
                    ...
                    <li>
                        <span class="menu-item @if(Request::is('historique')) active @endif">
                            <i class=" fas fa-solid fa-chart-line-up-down @if(Request::is('historique')) active-icon @endif"></i> <a href="{{route('historique')}}"><span class="menu-text">Historique</span></a>
                        </span>
                    </li>
                </ul>
