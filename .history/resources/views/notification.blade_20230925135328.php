    ...
    <div class="container">
        ...
        <div id="ntfctns" class="dropdown">
            ...
            <ul>
                ...
                <li class="ntfctn unr-ntfctn">
                    <a href="void:;"><img src="{{asset('//image/eau(1).png}}"><b>réfrigerateur </b>Votre refrigerateur a consommé le plus </a>
                </li>
                <li class="ntfctn">
                    <a href="void:;"><img src="http://dummyimage.com/30x30/EA5625/ffffff.jpg&text=img"><b>Detection</b>cet appareil est énergivore </a>
                </li>
                <li class="ntfctn">
                    <a href="void:;"><img src="{{asset('//image/eau(1).png}}"><b>télévission </b>Votre télévision à consommé le plus </a>
                </li>
