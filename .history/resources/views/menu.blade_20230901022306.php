    ...
    <body>
        ...
        <div class="menu-container">
            ...
            <div id="mySidebar" class="sidebar">
                ...
                <a href="{{route('Surveillance')}}">Accueil</a>
                <a href="{{route('Surveillance')}}">Régulation de l'électricité</a>
                <a href="{{route('Surveillance')}}">Profil</a>
                <a href="{{route('Surveillance')}}">Surveillance de données</a>
                <a href="{{route('Surveillance')}}">Prédiction</a>
                <a href="{{route('Surveillance')}}">Notification</a>
                <a href="{{route('Surveillance')}}">Historique</a>
            </div>
        </div>
