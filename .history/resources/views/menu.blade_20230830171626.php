                ...
                <ul class="menu-horizontal fixed-top wrap">
                    ...
                    <li>
                        <span class="menu-item @if(Request::is('historique')) active @endif">
                            <i class="<i class="fa-sharp fa-regular fa-clock-rotate-left"></i> @if(Request::is('historique')) active-icon @endif"></i> <a href="{{route('historique')}}"><span class="menu-text">Historique</span></a>
                        </span>
                    </li>
                </ul>
