        ...
        <div class="content">
                ...
                <div class="notification-container">
                    <div class="notification">
                        <h1>Notification <i class="fas fa-bell" style="width: 50px; height: 50px; padding-left:10px; padding-right:10px;color"></i></h1>
                        <p>Votre chauffe-eau a consommé le plus durant ce mois de septembre.</p>
                    </div>
                    <div class="notification">
                        <h1>Notification <i class=" fas fa-bell" style="width: 50px; height: 50px; padding-left:10px; padding-right:10px;"></i></h1>
