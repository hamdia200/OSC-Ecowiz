        ...
        <div class="content">
                <div class="circle-container">
                    <div class="chart-container">
                        ...
                        <div class="icon">
                            <img src="chauffe-eau-icon.png" alt="Chauffe-eau" width="80" height="80">
                ...
                <script>
                    ...
                    var myChart = new Chart(ctx, {
                        type: 'pie', // Type de graphique en forme de cercle
                        data: {
                            labels: ['Section 1', 'Section 2', 'Section 3'], // Étiquettes de chaque section
                            datasets: [{
                                data: [30, 40, 50], // Données pour chaque section
                        ...
                        plugins: {
                            ...
                            pieceLabel: {
                                ...
                                images: [{src: 'chauffe-eau-icon.png', width: 40, height: 40}] // Configurer l'image de l'icône
                            }
                        }
                    }
                    });
