                ...
                <div class="circle-container">
                    <div class="chart-container">
                        ...
                        <div class="icon">
                            ...
                            <img src="clim-icon.png" alt="Climatiseur" width="80" height="80">
                    ...
                    var myChart = new Chart(ctx, {
                        ...
                        plugins: {
                            ...
                            pieceLabel: {
                                ...
                                images: [{src: 'chauffe-eau.png', width: 40, height: 40},{src: 'chauffe-eau.png', width: 40, height: 40}] // Configurer l'image de l'icône
                            }
                        }
                    }
                    });
