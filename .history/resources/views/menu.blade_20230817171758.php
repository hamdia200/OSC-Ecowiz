    ...
    <ul class="menu-horizontal fixed-top">
            ...
            <li>
                <span class="menu-item">
                    ...
                    <i class="fas fa-bolt"><span class="menu-text">Régulation d'éléctricité </span>
                </span>
            </li>
            ...
            <li>
                <span class="menu-item">
                    <!-- <img src="{{asset('image/donnee.png') }}" alt="Icone 1" class="menu-icon"> -->
                    <i class="fas fa-home"><span class="menu-text">Surveillance des données </span>
                </span>
            </li>
            <li>
                <span class="menu-item">
                    <!-- <img src="{{asset('image/sup.png') }}" alt="Icone 1" class="menu-icon"> -->
                    <i class="fas fa-home"><span class="menu-text">Support</span>
                </span>
            </li>
            <li>
                <span class="menu-item">
                    <!-- <img src="{{asset('image/assist.png') }}" alt="Icone 1" class="menu-icon"> -->
                    <i class="fas fa-home"><span class="menu-text">Assistance</span>
                </span>
            </li>
        </ul>
