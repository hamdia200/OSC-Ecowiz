...
<html lang="fr">
    ...
    <div class="row">
        <div class="col-md-6 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img id="profileImage" src="{{asset('/image/connexion.png')}}" width="150px">
                <select id="imageSelect" class="form-control mt-2">
                    <option value="user.png">Image 1</option>
                    <option value="users.png">Image 2</option>
                    <option value="conn.png">Image 3</option>
                </select>
                <button id="changeImageButton" class="btn btn-secondary mt-2">Changer l'image</button><span class="font-weight-bold">Ecowiz</span><span class="text-black-50">ecowiz@gmail.com</span><span> </span></div>
        </div>
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
...
<script>
    ...
    const imageBaseUrl = "{{ asset('image/') }}"; // Chemin de base des images
    const imageExtension = ".png"; // Extension des images

    imageSelect.addEventListener('change', function() {
        const selectedImage = imageSelect.value;
        profileImage.src = imageBaseUrl + selectedImage + imageExtension;
    });
});
