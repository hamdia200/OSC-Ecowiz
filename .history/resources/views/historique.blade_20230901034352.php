...
<head>
    ...
    height: 49px;
    position: absolute;
    margin-top: 6rem; /* Ajustez la valeur pour le placement vertical */
    left: 50%;
    transform: translateX(-50%); /* Centre horizontalement */
    background-color: white; /* Ajoutez une couleur de fond si nécessaire */
    padding: 10px; /* Ajoutez du remplissage pour l'apparence */
    box-shadow: 0px 2px 6px rgba(0, 0, 0, 0.2); /* Ajoutez une ombre si nécessaire */
    z-index: 2; /* Assurez-vous 
        }
        .charts{
            width: 600px;
            height: 571px;
