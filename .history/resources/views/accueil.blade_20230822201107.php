        ...
        <div class="content">
                <div class="circle-container">
                    <div class="chart-container">
                        ...
                        <div class="icon">
                            <i class="fas fa-bolt icon-left" style="position: absolute; width: 30px; height: 30px; transition: opacity 0.2s;"></i>
                            <i class="fas fa-snowflake icon-top" style="position: absolute; width: 30px; height: 30px; transition: opacity 0.2s;"></i>
                            <i class="fas fa-utensils icon-bottom" style="position: absolute; width: 30px; height: 30px; transition: opacity 0.2s;"></i>
