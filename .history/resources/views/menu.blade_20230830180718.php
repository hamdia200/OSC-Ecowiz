                ...
                <ul class="menu-horizontal fixed-top wrap">
                    ...
                    <li>
                        <span class="menu-item @if(Request::is('historique')) active @endif">
                            <i class="online_prediction_FILL0_wght400_GRAD0_opsz48 @if(Request::is('historique')) active-icon @endif"></i> <a href="{{route('historique')}}"><span class="menu-text">Historique</span></a>
                        </span>
                    </li>
                </ul>
