...
$(document).ready(function () {
    ...
    $('.timepicker').on('show.timepicker', function (e) {
        var button = $(this).next('.input-group-addon');
        var position = button.position();
        var topOffset = position.top - $(this).outerHeight();

        $(this).data('timepicker').$widget.css({
            'top': topOffset,
            'left': position.left
        });
    });
