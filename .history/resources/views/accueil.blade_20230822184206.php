        ...
        <div class="content">
                ...
                <script>
                    ...
                    var myChart = new Chart(ctx, {
                        ...
                        data: {
                            labels: ['Chauffe-eau {src: 'venit.png', width: 40, height: 40}', 'Climatisation', 'Téléviseur','Réfrigerateur','ventilateur','ampoule','Thermostre'], // Étiquettes de chaque section
                            datasets: [{
