...
<div class="d-flex justify-content-center" style="padding-top: 30px;">
    ...
    <div class="input-group date timepicker justify-content-end">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <tr>
                    ...
                    <td>Switch 1</td>
                    <td><button class="toggle-btn btn btn-sm btn-success" data-state="on">Active
                        <i class="fa fa-toggle-on"></i> <!-- Icône pour l'état "on" -->
            ...
            <tr>
                    ...
                    <td>Switch 2</td>
                    <td><button class="toggle-btn btn btn-sm btn-success" data-state="on">desactive</button></td>
                    <td>
							<a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
            ...
            <tr>
                    ...
                    <td>Switch 3</td>
                    <td><button class="toggle-btn btn btn-sm btn-success" data-state="on">Active</button></td>
                    <td>
							<a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
