                ...
                <ul class="menu-horizontal fixed-top wrap">
                    ...
                    <li>
                        <span class="menu-item @if(Request::is('prediction')) active @endif">
                            <i class="fas fa-chart-mixed-up-circle-currency @if(Request::is('prediction')) active-icon @endif"></i> <a href="{{route('prediction')}}"><span class="menu-text">Prédiction</span></a>
                        </span>
                    </li>
                    <li>
