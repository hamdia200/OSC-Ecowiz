...
<script>
        ...
        // Générer les options pour le jour (1 à 31)
        for (let i = 1; i <= 31; i++) {
        ...
        // Générer les options pour le mois (1 à 12)
        const moisNoms = ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Décembre"];
        for (let i = 1; i <= 12; i++) {
        const option = document.createElement("option");
        option.value = i < 10 ? "0" + i : i;
        option.textContent = moisNoms[i - 1];
        moisSelect.appendChild(option);
        }

        // Générer les options pour l'année (de l'année actuelle à +5 ans)
                ...
                <div class="container">
                    <div class="poste">
                                <div class="date-selection">
                                    <h1 class="text">Poste de conso</h1>
                                    <select id="jour">
