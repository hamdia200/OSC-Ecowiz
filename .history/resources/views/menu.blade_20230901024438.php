    ...
    <body>
        ...
        <div class="menu-container">
            ...
            <div id="mySidebar" class="sidebar">
                ...
                <a href="{{route('regulation')}}"><i class="fas fa-bolt"></i>Régulation de l'électricité</a>
                <a href="{{route('profil')}}"><i class="fas fa-user"></i>Profil</a>
                <a href="{{route('Surveillance')}}"><i class="fas fa-eye"></i>Surveillance de données</a>
                <a href="{{route('prediction')}}"><i class="fas fa-chart-line"></i>Prédiction</a>
                <a href="{{route('notification')}}"><i class="fas fa-bell"></i>Notification</a>
                <a href="{{route('historique')}}"><i class="fas fa-history"></i>Historique</a>
            </div>
        </div>
