...
<html lang="fr">
    ...
    <div class="row">
        <div class="col-md-6 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img id="{{asset('/image/connexion.png')}}" width="150px"> <button id="changeImageButton" class="btn btn-secondary mt-2">Changer l'image</button><span class="font-weight-bold">Ecowiz</span><span class="text-black-50">ecowiz@gmail.com</span><span> </span></div>
        </div>
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
